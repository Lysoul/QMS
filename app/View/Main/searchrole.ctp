<div class="container">
    ...
    <div class="row" align="center"> 
          ...
          <div class="col s4"> <a class="waves-effect waves-light btn" style="background-color: #b42e34;color:#B42E34;text-transform: capitalize; font-size:20px"><b style="color:#FFFFFF">Role & Responsibility</b></a> </div>
          <div class="col s4"> 
        ...
        <div class="row" align="center"> 
            <?php echo $this->Form->create('searchforrole', array('class' => 'col s12'));  ?>


                    <div class="input-field col s2" align="right">
                        <h5 id="head">I'm a</h5>
                    </div>
