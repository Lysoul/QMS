<div class="container">
    ...
    <div class="row" align="center"> 
          <div class="col s4">  
            <a id="pbtn" class="waves-effect waves-light btn" style="background-color: #b42e34;text-transform: capitalize; font-size:20px"><b style="color:#FFFFFF">Process & Subprocess </b></a> 
        </div>
          <div class="col s4"> 
            <?php 
    ...
    <div class="row" align="center"> 
            <?php echo $this->Form->create('searchforprocess', array('class' => 'col s12'));  ?>

                    <div class="input-field col s3" align="right">
                        <h5 id="head">Process name is</h5>
                    </div>
